 ...
 * the matching document exists in Sanity, the CMS wins — nothing here needs to
 * be edited again.
 */
...
export const fallbackSettings: SiteSettings = {
  ...
  socialLinks: [
    ...
    { _key: "cv", label: "Resume", url: "/resume.pdf", icon: "file" },
...
export const fallbackHome: HomePage = {
  heroName: "Sanaullah Pashtoon",
  heroSubtitle: "MCS @ UC Irvine · BS Mathematics",
  ...
  currentFocus: entries([
    ...
    [
      "Graduate coursework",
      "MCS at UC Irvine, leaning toward performance and correctness.",
    ],
  ]),
...
export const fallbackNow: NowPage = {
  ...
  currentFocus: entries([
    ...
    ["Graduate coursework", "MCS at UC Irvine."],
  ]),
  building: entries([
  ...
  courses: entries([["Graduate algorithms"], ["Embedded systems design"]]),
  goals: entries([
